...
from mathclaw.agent.tools.mcp import MCPToolWrapper, connect_mcp_servers
from mathclaw.agent.tools.registry import ToolRegistry
from mathclaw.config.schema import MCPServerConfig
...
async def test_connect_mcp_servers_enabled_tools_warns_on_unknown_entries(
    ...
    monkeypatch.setattr("mathclaw.agent.tools.mcp.logger.warning", _warning)
