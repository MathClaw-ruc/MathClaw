...
table, allowing mathclaw to send multiple cards instead of failing.
"""

# Check optional Feishu dependencies before running tests
try:
    from mathclaw.channels import feishu
...
from mathclaw.channels.feishu import FeishuChannel
