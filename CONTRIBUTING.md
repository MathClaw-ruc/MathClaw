...
mathclaw is built with a simple belief: good tools should feel calm, clear, and humane.
...
git clone https://github.com/HKUDS/mathclaw.git
cd mathclaw
...
# Format code
ruff format mathclaw/
```

## Code Style

We care about more than passing lint. We want mathclaw to stay small, calm, and readable.
...
Please feel free to open an [issue](https://github.com/HKUDS/mathclaw/issues), join the community, or simply reach out:

- [Discord](https://discord.gg/MnCvHqpUGB)
- [Feishu/WeChat](./COMMUNICATION.md)
- Email: Xubin Ren (@Re-bin) — <xubinrencs@gmail.com>

Thank you for spending your time and care on mathclaw. We would love for more people to participate in this community, and we genuinely welcome contributions of all sizes.
